...
data_SPIR_Ed <- read.table(file = "Donnees/Data_SPIR_Edouard_Hoarau/SPIR_Hoarau_var.csv"
                           , header = T
                           , sep = ";"
                           , stringsAsFactors = T
                           , row.names = 1
...
# Time difference of 2.934442 hours avec nb.simu = 100 ,rep.max = 6 & sfClusterApplyLB

# Time difference of 3.419994 hours avec nb.simu = 100 ,rep.max = 6 & sfSapply
...
# Ne marche qu'avec la sortie Sapply !!!!
